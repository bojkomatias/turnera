...
class ConsultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consult" do
    assert_difference('Consult.count') do
      post consults_url, params: { consult: { data: @consult.data, doctor_id: @consult.doctor_id, patient_id: @consult.patient_id } }
    end
  ...
  test "should update consult" do
    patch consult_url(@consult), params: { consult: { data: @consult.data, doctor_id: @consult.doctor_id, patient_id: @consult.patient_id } }
