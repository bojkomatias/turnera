class ConsultsController < ApplicationController
  ...
  def index
    ...
    @consults = @consults.joins(:doctor).where(:doctor => {:speciality_id => params[:speciality_id]}) if params[:speciality_id]
  ...
  private
    ...
    def consult_params
      params.require(:consult).permit(:data, :doctor_id, :patient_id)
    end
end
